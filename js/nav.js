...
<div class="menu1" onclick="instr()">                                    <div class="bull"></div>Instruction   </div>\
<div class="menu1" onclick="popName()"> <div class="bull"></div>Register </div>\		                                                                        </div></div>                                <div class="overlay2" onclick="closeNav()">                                </div><!-- -->';
 bar = '';
...
&laquo; Back \
  ...
  <div class="headaChap" style="font-size:18px;">    \
      ...
      <div id="mmsg"></div>\
      <div class="pay" style="margin-top:10px;" onclick="activ82()">\
      Activate \
      </div>\
